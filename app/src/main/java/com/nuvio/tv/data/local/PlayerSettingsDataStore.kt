...
data class SubtitleStyleSettings(
    ...
    val lineSpacing: Int = 100, // Percentage (50-200), ExoPlayer only
...
class PlayerSettingsDataStore @Inject constructor(
            ...
            PlayerSettings(
                ...
                subtitleStyle = run {
                    ...
                    SubtitleStyleSettings(
                        ...
                        lineSpacing = (prefs[subtitleLineSpacingKey] ?: 100).coerceIn(50, 200),
    ...
    suspend fun setSubtitleLineSpacing(lineSpacing: Int) {
        store().edit { it[subtitleLineSpacingKey] = lineSpacing.coerceIn(50, 200) }
    }
